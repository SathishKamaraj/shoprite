...
public class BaseClass {
			...
			try {
				if (browerName.equalsIgnoreCase("chrome")) {
					System.setProperty("webdriver.chrome.driver",
							System.getProperty("user.dir") + "G:\\selenium\\Maven_BD\\Driver\\chromedriver.exe");
					driver = new ChromeDriver();

				} else if (browerName.equalsIgnoreCase("firefox")) {
					System.setProperty("webdriver.gecko.driver",
							System.getProperty("user.dir") + "G:\\selenium\\Maven_BD\\Driver\\geckodriver.exe");
		...
		public static String jdbcConnection(int key, String dbName, String userName, String password, String query)
			...
			// create statement
			java.sql.Statement createStatement = con.createStatement();
			// execute query
